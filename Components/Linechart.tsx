...
const Linechart = () => {
  ...
  const [data, setData] = useState<string[] | number[]>([10, 30, 50, 20, 40, 60, 40]);
  ...
  useEffect(() => {
    ...
    svg.append("g")
      ...
      .call(xAxis)
      .select(".domain").style("visibility", "hidden")
    ...
    svg.selectAll('.line')
      ...
      .attr('fill', 'none')
      .attr('stroke', '#47b747').attr('stroke-width', 2)
